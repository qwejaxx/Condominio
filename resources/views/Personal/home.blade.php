...
@section('scriptsExtra')
    <script src="{{ asset('Resources/js/personal.js') }}"></script>
    <script src="{{ asset('Resources/js/select2.min.js') }}"></script>
@endsection
@section('controllerLinks')
    <input id="url-index" type="hidden" name="url-index" value="{{ route('indexPs') }}">
    <input id="url-store" type="hidden" name="url-store" value="{{ route('storePs') }}">
    <input id="url-show" type="hidden" name="url-show" value="{{ route('Personal') }}">
@endsection
@section('Titulo')
    <i class="fa-solid fa-list me-2"></i>Lista de Personal de Servicio
@endsection
@section('Contenido')
    <div class="row justify-content-between">
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-3 d-flex justify-content-end">
            <button class="btn btn-secondary btn-sm mb-3" type="button" id="btnAgregar" data-bs-toggle="modal"
                ...
                <i class="fa-solid fa-plus me-2"></i>Nuevo Personal
            </button>
            <div class="modal fade" id="modalMain" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-custom">
                        ...
                        <form id="rsdtForm">
                            <div class="header">
                                <div><i class="fa-solid fa-sitemap me-2"></i><span id="modal-titulo">Nuevo Personal</span>
                                </div>
                            ...
                            <div class="body">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <select class="form-select form-select-sm"
                                        data-url="{{ route('indexRolesPs') }}" id="rol" name="rol">
                                    </select>
                                </div>
                            </div>
                            <div class="footer">
