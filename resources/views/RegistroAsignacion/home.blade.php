...
@section('scriptsExtra')
    <script src="{{ asset('Resources/js/asignaciones.js') }}"></script>
    <script src="{{ asset('Resources/js/select2.min.js') }}"></script>
@endsection
@section('controllerLinks')
    <input id="url-index" type="hidden" name="url-index" value="{{ route('indexAsig') }}">
    <input id="url-store" type="hidden" name="url-store" value="{{ route('storeAsig') }}">
    <input id="url-show" type="hidden" name="url-show" value="{{ route('Asignaciones') }}">
...
@endsection
@section('Titulo')
    <i class="fa-solid fa-list me-2"></i>Asignación de actividades
@endsection
@section('Contenido')
            ...
            <div class="modal fade" id="modalMain" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-custom">
                        <form id="rsdtForm">
                            <input id="id_asip" type="hidden" name="id_asip">
                            <div class="header">
                                <div><i class="fa-solid fa-sitemap me-2"></i><span id="modal-titulo">Registrar asignación</span>
                                </div>
                            ...
                            <div class="body">
                                ...
                                <div class="d-flex flex-column mb-1">
                                    <label for="planificacion_id_asip" class="label-form">Actividad:</label>
                                    <select class="form-select form-select-sm" id="planificacion_id_asip"
                                        name="planificacion_id_asip">
                                    </select>
                                </div>
                                <div class="d-flex flex-column mb-1">
                                    <label for="participante_id_asip" class="label-form">Participante:</label>
                                    <select class="form-select form-select-sm" id="participante_id_asip" name="participante_id_asip">
                                    </select>
                                </div>
                            </div>
                            <div class="footer">
